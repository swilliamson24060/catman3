...
signal seed_planted(seed_value: int)
signal growth_plot_advanced(cells_resolved: int)
signal seed_resolved()
signal terrain_tile_unlocked(tile_id: String)
signal expedition_departed(resident_id: StringName, area_id: StringName)
signal expedition_returned(resident_id: StringName, area_id: StringName)
